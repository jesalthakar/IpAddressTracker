...
const ipData = document.querySelector("#ip").querySelector(".info__data");
const locationData = document.querySelector("#location").querySelector(".info__data");
const timezoneData = document.querySelector("#timezone").querySelector(".info__data");
const ispData = document.querySelector("#isp").querySelector(".info__data");
...
async function fetchData(inputValue, inputType) {
    ...
    const API_Key ="at_ThuuFdnXJtSJYTIZVryDzGSIhKDvs&ipAddress=8.8.8.8";
